...
class Predictor:
    ...
    def plot_predictions(self, stations: list):
        ...
        for station_id in stations:
            ...
            self._split_train_test(self.num_training_years, station_id)
    ...
    def _split_train_test(self, num_training_years, station_id):
        ...
        df = pd.read_csv(f"./assets/{station_id}.csv", sep=";")
